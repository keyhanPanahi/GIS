...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a class="text-primary" href="{{ route('admin.place.index') }}">فهرست مکان
                ها</a></li>
        <li class="breadcrumb-item active">ویرایش مکان</li>
    </ol>
</nav>
            ...
            <div class="bs-stepper-header">
                <div class="step active" data-target="#account-details">
                    <button type="button" class="step-trigger" aria-selected="true">
                        ...
                        <span class="bs-stepper-subtitle">ویرایش اطلاعات مالک</span>
                      </span>
                    </button>
                </div>
                <div class="line"></div>
                <div class="step" data-target="#personal-info">
                    <button type="button" class="step-trigger" aria-selected="false">
                        ...
                        <span class="bs-stepper-subtitle">ویرایش اطلاعات مکان</span>
                      </span>
                    </button>
                </div>
                <div class="line"></div>
                <div class="step" data-target="#more-info">
                    <button type="button" class="step-trigger" aria-selected="false">
                        ...
                        <span class="bs-stepper-subtitle">ویرایش اطلاعات بیشتر مکان</span>
                      </span>
                    </button>
                </div>
                <div class="line"></div>
                <div class="step" data-target="#avatar">
                    <button type="button" class="step-trigger" aria-selected="false">
                        ...
                        <span class="bs-stepper-subtitle">ویرایش مکان برروی نقشه</span>
                      </span>
                    </button>
                </div>
                <div class="line"></div>
                <div class="step" data-target="#roles">
                    <button type="button" class="step-trigger" aria-selected="false">
                        ...
                        <span class="bs-stepper-subtitle">ویرایش فایل</span>
                      </span>
                    </button>
                </div>
            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="owner_fname" id="owner_fname"
                                           value="{{ old('owner_fname', $place->owner_fname) }}" class="form-control text-start" dir="ltr"
                                           placeholder="رضا">
                                    <div class="mt-1">
                                        @error('owner_fname')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="owner_lname" id="owner_lname"
                                           value="{{ old('owner_lname',$place->owner_lname) }}" class="form-control text-start" dir="ltr"
                                           placeholder="رضایی">
                                    <div class="mt-1">
                                        @error('owner_lname')
                                        <span class="text-danger">* {{ $message }}</span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="owner_nationalcode" id="owner_nationalcode"
                                           value="{{ old('owner_nationalcode',$place->owner_nationalcode) }}" class="form-control text-start"
                    ...
                    <div id="personal-info" class="content">
                            ...
                            <div class="row g-3">
                                    ...
                                    <select id="state_id" name="state_id" class="form-select select2">
                                        @foreach ($states as $state)
                                            <option value="{{ $state->id }}"
                                                    @if(old('state_id',$place->postal_address[0]) == $state->id) selected @endif>{{ $state->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="mt-1">
                                        @error('state_id')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="address[0]" id="address" value="{{ old('address[0]',$place->postal_address[2]) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="address[1]" id="address" value="{{ old('address[1]',$place->postal_address[3]) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="address[2]" id="address" value="{{ old('address[2]',$place->postal_address[4]) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="address[3]" id="address" value="{{ old('address[3]',$place->postal_address[5]) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="address[4]" id="address" value="{{ old('address[4]',$place->postal_address[6]) }}"
                                           class="form-control" placeholder="2">
                                    <div class="mt-1">
                                        @error('address')
                                        <span class="text-danger">* {{ $message }}</span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="address[5]" id="address" value="{{ old('address[5]',$place->postal_address[7]) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="postal_code" id="postal_code"
                                           value="{{ old('postal_code',$place->postal_code) }}" class="form-control"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="water_counter_number" id="water_counter_number"
                                           value="{{ old('water_counter_number',$place->water_counter_number) }}" class="form-control"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="electric_counter_number" id="electric_counter_number"
                                           value="{{ old('electric_counter_number',$place->electric_counter_number) }}" class="form-control"
                                           placeholder="0123456789123">
                                    <div class="mt-1">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="gas_counter_number" id="gas_counter_number"
                                           value="{{ old('gas_counter_number',$place->gas_counter_number) }}" class="form-control"
                                           placeholder="0123456789123">
                                    <div class="mt-1">
                        ...
                        <div id="avatar" class="content">
                            ...
                            <div class="row g-3">
                                <div class="col-6 d-flex justify-content-between">
                                    <input type="text" name="point" id="point" value="{{ 'LatLng('.$place->point.')' }}" class="form-control">
                                </div>
                                <div class="mt-1">
                                    @error('point')
                                    <span class="text-danger">* {{ $message }}</span>
...
@section('page-js')
    ...
    <script>
        ...
        const map = L.map('map').setView([{{$place->point}}], 15);
        ...
        L.marker([{{$place->point}}]).addTo(map)
            .bindPopup('<b> مکان قبلی شما ! </b> ').openPopup();
    </script>
    ...
    <script>
        ...
        const GetCity = function () {
            $.ajax({
                ...
                success: function (response) {
                    city.empty();
                    const html = response.map(res => `<option value="${res.id}" ${res.id == '{{ $place->postal_address[0] }}' ? 'selected' : ''}>${res.name}</option>`);
                    city.append(html);
                }
            });
        };
